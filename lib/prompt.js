...
/**
 * Creates an interactive form with the given fields.
 * 
 * @param {array} fields
 * @param {object} options
 * @param {function} callback
 */
exports.form = function form (fields, options, callback) {
...
/**
 * Creates a single form input.
 *
 * @param {object} options
 * @param {function} callback
 */
exports.input = function input (options, callback) {
