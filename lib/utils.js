...
exports.getTheLatestCommitSha = function getTheLatestCommitSha(repoUrl, creds, cb) {
  scripts.runAndWatchForPasswords('git', [ 'ls-remote', repoUrl ], { cwd: null }, creds, function (err, stdout) {
    if (err) {
      return cb(err);
    }
