...
var unicode = require('./utils').unicode;
var either = require('./utils').either;
var requireFiber = require('./utils').requireFiber;
var common = require('./common');
var logs = require('./logs');

module.exports = function config (name, options, cb) {
...
function findSettingsByNameOrCreate (pathToConfig, name, cb) {
  ...
  logs.system('available configs are: ' + Object.keys(pathsByName));
